...
public class VagaIT {
    ...
    @Test
    public void criarVaga_ComComCodigoJaExistente_RetornarErrorMessageComStatus409(){
        testClient.post()
                .uri("/api/v1/vagas")
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
    ...
    public void criarVaga_ComDadoInvalidos_RetornarErrorMessageComStatus422(){
        ...
        testClient.post()
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
                .bodyValue(new VagaCreateDto("A-012", "DESOCUPADA"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody()
                .jsonPath("status").isEqualTo(422)
    ...
    @Test
    public void buscarVaga_ComCodigoInexistente_RetornarVagaComStatus404(){
        testClient.get()
    ...
    @Test
    public void criarVaga_ComUsuarioSemPermissao_RetornarVagaComStatus403(){
        testClient.post()
                .uri("/api/v1/vagas")
                .contentType(MediaType.APPLICATION_JSON)
