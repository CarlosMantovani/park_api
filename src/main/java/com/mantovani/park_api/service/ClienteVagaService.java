...
import com.mantovani.park_api.repository.ClienteVagaRepository;
...
public class ClienteVagaService {
    ...
    public ClienteVaga buscarPorRecibo(String recibo) {
        return repository.findByReciboAndDataSaidaIsNull(recibo).orElseThrow(() -> new EntityNotFoundException(
                String.format("Recibo '%s' não encontrado no sistema ou check-out ja realizado", recibo )
        ));
    }
    @Transactional(readOnly = true)
    public long getTotalDeVezesEstacionametoCompleto(String cpf) {
