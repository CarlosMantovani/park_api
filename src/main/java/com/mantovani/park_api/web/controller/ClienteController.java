...
import com.mantovani.park_api.service.ClienteService;
...
import com.mantovani.park_api.web.dto.mapper.ClienteMapper;
...
@Tag(name = "Clientes", description = "Contem todos as operações relativas ao recurso de um cliente")
...
public class ClienteController {
    ...
    @Operation(summary = "Criar um novo cliente", description = "Recurso para criar um novo cliente vinculado a um usuário cadastrado0 " +
            "Reqiosição exige o uso de um bearer token. Acesso restrito a Role='CLIENTE'",
            responses = {
