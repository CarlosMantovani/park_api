...
public class VagaController {
    ...
    @Operation(summary = "Localizar uma vaga",
            ...
            responses = {
                    @ApiResponse(responseCode = "200", description = "Recurso criado com sucesso",
                            content = @Content(mediaType = " application/json;charset=UTF-8", schema = @Schema(implementation = VagasResponseDto.class))),
    ...
    @GetMapping("/{codigo}")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<VagasResponseDto> getByCodigo(@PathVariable String codigo){
